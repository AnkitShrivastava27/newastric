...
export default function Landing() {
  ...
  return (
    <div className="landing-page">
      ...
      <section className="section final-cta"><div className="container"><div className="cta-card reveal"><p className="section-label">Ready to transform your business?</p><h2>Astric is now live on the Play Store.</h2><p>Experience Astric — the AI-powered business suite & CRM designed to streamline operations, boost productivity, and scale your growth.</p><div className="cta-actions"><a href={PLAY_STORE_URL} className="btn btn-gold" target="_blank" rel="noopener noreferrer">Download</a><Link to="/support" className="btn btn-outline">Read support</Link></div></div></div></section>
    </div>
  );
}
